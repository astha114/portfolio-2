...
const Projects = () => {
  return (
    <section className="bg-[#0a192f] px-8 text-white  flex flex-col justify-center">
      <div className="flex">
        <div className="flex flex-col w-[100%]">
          ...
          <div className="my-8 text-lg text-slate-500">
            {/* Project 1 */}
            <div className="lg:flex relative my-8 ">
              <div className="lg:w-[60%] h-[100%] bg-red-400">
              ...
              <div className="flex-col lg:w-[40%]">
                <p className="flex lg:justify-end text-2xl mt-2 font-bold text-slate-300">
                  Food App
                </p>
            ...
            {/* Project 2  */}
            <div className="lg:flex relative my-24">    
              <div className="flex-col lg:w-[40%]">
                <p className="flex justify-start text-2xl font-bold text-slate-300">
                  Urbanic Clone
                </p>
                <div className="lg:absolute right-[40%] z-10 text-slate-400 mt-4 lg:w-[60%] ">
                  <div className="bg-[#112240] p-4 rounded-md">
              ...
              <div className="absolute right-0 w-[60%] lg:h-[100%] bg-[#0a192f] opacity-70 hover:opacity-20"></div>
            </div>
          </div>
        </div>
      </div>
